...
class Classifier:
    ...
    def prepare_model(self):
        self.prepared_text = self.vectorizer.fit_transform(self.text)
...
class Linear(Classifier):
    def __init__(self, text, sentiment):
        ...
        self.classifier = SGDClassifier(loss='hinge', penalty='l2', alpha=1e-3, random_state=42, max_iter=7, tol=None)
